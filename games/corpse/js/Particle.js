/* global Vector2 ctx particles particleSprites images scale Sprite UV */
...
class NewParticle {
  constructor(x, y, options = {}) {
    ...
    const uv = new UV(
                (frame % Math.floor(this.sprite.width / this.width)) * this.width,
      Math.floor(frame / Math.floor(this.sprite.width / this.width)) * this.height,
      this.width,
      this.height,
    );
