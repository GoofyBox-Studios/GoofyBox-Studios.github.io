...
function loadLevel(l) {
  ...
  for (let i = 0; i < levels[currentLevel].flames.length; i++) {
    ...
    emitters.push(new Emitter(c.x * 16, c.y * 16, function () {
...
const tileSprites = [
  new Sprite("https://cdn.glitch.global/74da3bde-3b8c-415d-917a-158276350589/tilesBrown.png?v=1715480737063"),
  new Sprite("https://cdn.glitch.global/74da3bde-3b8c-415d-917a-158276350589/tilesGreen.png?v=1715480737317"),
  new Sprite("https://cdn.glitch.global/74da3bde-3b8c-415d-917a-158276350589/tilesGrey.png?v=1715480737547"),
];
...
function collidingWithRound(a, b) {
  ...
  if (distX > (a.collision.width/2 + b.collision.radius)) { return false; }
  if (distY > (a.collision.height/2 + b.collision.radius)) { return false; }

  if (distX <= (a.collision.width/2)) { return true; } 
  if (distY <= (b.collision.height/2)) { return true; }
...
function drawCollisionFor(entity, colour) {
  if (entity.collision && DEBUG_SHOW_COLLISION) {
    ...
    ctx.beginPath();
    ctx.rect(
      entity.position.x + entity.collision.offsetX,
      entity.position.y + entity.collision.offsetY,
